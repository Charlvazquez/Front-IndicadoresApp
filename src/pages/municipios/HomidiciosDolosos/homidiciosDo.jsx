...
export default function HomidiciosDolosos() {

  const URL = 'http://localhost:5050/indicadores/homicidios/dolosos/tamaulipas/'
  ...
  <div className="container-fluid">
    <ol className="breadcrumb">
      <li className="breadcrumb-item">Lista De Homicidios Dolosos</li>
